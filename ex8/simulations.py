...
def simulation(id_list, times = 10 , mod = 10**6, func = hash):
...
def main():
    ...
    parser.add_argument('--idlistsize', '-n', type=int, default=5000)
...
#    " start simulation
    ...
    if args.toprime:
        mod = next_prime(mod)
    func = hash_functions[args.function](args.minhashsize) if 0<=args.function<len(hash_functions) else hash
